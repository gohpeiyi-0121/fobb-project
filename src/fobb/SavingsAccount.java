 ...
 * with custom interest calculation and withdrawal rules.
 *
 * @author [Goh Pei Yi]
 */
public class SavingsAccount extends Account {
    ...
    /**
     * Overridden withdraw method with savings account rules 1. Cannot withdraw
     * below minimum balance 2. Cannot exceed withdrawal limit per transaction
     *
    ...
    /**
     * Overridden calculateInterest method Implements compound interest
     * calculation for savings account Prints interest information (matching
     * parent class style)
     */
    @Override
    ...
    /**
     * Method to increment months active (simulates time passing) Should be
     * called monthly by the banking system
     */
    ...
    /**
     * Display enhanced account info including savings-specific details Extends
     * parent's displayAccountInfo method
     */
